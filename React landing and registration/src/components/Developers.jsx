...
const developers = [
  {
    ...
    image: 'A professional portrait of a female software developer named Mahnoor, smiling confidently.'
  },
  {
    name: 'Muhammad Haris Khan',
    role: 'Full Stack Developer',
    gradient: 'from-blue-500 to-cyan-500',
    image: 'A professional portrait of a male software developer named Muhammad Haris Khan, looking at the camera.'
  }
];
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Two talented developers working together to revolutionize attendance tracking.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="w-32 h-32 mx-auto rounded-full mb-6 shadow-lg overflow-hidden border-4 border-white/10">
              <img className="w-full h-full object-cover" alt="Portrait of Mahnoor" src="/public/Me.jpg" />
            </div>
